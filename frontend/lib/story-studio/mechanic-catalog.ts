import type { ConceptFamily, MechanicFamily } from "./kindergarten-curriculum";
...
export function getAllowedMechanicsForConcept(conceptFamily: ConceptFamily): MechanicFamily[] {
