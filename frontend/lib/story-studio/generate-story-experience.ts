...
export async function generateStoryExperience(lesson: LessonSpec): Promise<StoryExperienceResponse> {
  const response = await fetch("/api/story-studio/story-experience", {
    method: "POST",
