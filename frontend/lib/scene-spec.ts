...
export function buildSeedSceneSpec(context: SceneSpecContext): SceneSpec {
    ...
    return {
      ...
      stages: [
        ...
        },
        {
          ...
          emoji: "💧",
          threshold: 33,
          fact: "A liquid can flow and pour.",
        },
        {
          id: "gas",
          label: "gas",
          emoji: "☁️",
          threshold: 70,
          fact: "A gas spreads into the air.",
        },
      ],
    };
  }
  ...
  return {
    kind: "fallback_tap",
    title: "Discovery Tap",
    instruction: "Press the discovery button and look for the idea that gets unlocked.",
    helperText: "Watch closely after each move. The change is your clue.",
    rewardFact: "Learning sticks better when a child sees change happen after an action.",
    paletteKey: "cosmos",
    buttonLabel: "Unlock Discovery",
  };
}
