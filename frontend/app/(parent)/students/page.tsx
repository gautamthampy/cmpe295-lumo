        ...
        <div className="mx-auto max-w-5xl space-y-8">
          <AuthCard accent className="space-y-4">
            ...
            <p className="max-w-3xl font-body text-base leading-7 text-on-surface-variant">
              Generate a short-lived sign-in code for a specific learner from the parent dashboard. Each code works once, expires quickly, and is also emailed to the parent address on file.
            </p>
          ...
          {dashboard.students.length === 0 ? (
            <AuthCard className="space-y-3">
              ...
              <p className="font-body leading-7 text-on-surface-variant">
                Student sign-in codes appear here once a learner profile exists under this parent account. The next implementation pass can connect profile creation into this dashboard.
              </p>
            </AuthCard>
          ) : (
